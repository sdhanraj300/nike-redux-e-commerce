      ...
      >
        <div className="grid items-center justify-items-center">
          ...
          <div className="flex items-center justify-between w-28 my-2">
            <div className="flex font-medium blur-effect-theme items-center bg-white/80 px-1 rounded">
          ...
          <div className="flex items-center gap-3 ">
            ...
            <button
              type="button"
              className="text-black px-2 py-1 bg-white/90 blur-effect-theme button-theme p-0.5 shadow shadow-sky-200"
            >
              {btn}
            </button>
          </div>
